...
public class CardConfig
{
    ...
    static CardConfig()
    {
        m_Dic = new Dictionary<int, CardClass>()
        {
            ...
            {400001, new CardClass() { id = 400001, name = "直击", icon = "400001直击", type = 4, cost = 1, leftAttribute = 1, rightAttribute = 5, blade = 3, magic = 0, defence = 0, glass = 0, vatality = 1, active_id = new List<List<int>>() { new List<int>() { 1, 1, 1 } }, passive_id = new List<List<int>>() {  } } },
            {400002, new CardClass() { id = 400002, name = "附魔打击", icon = "400002附魔打击", type = 4, cost = 2, leftAttribute = 1, rightAttribute = 2, blade = 3, magic = 3, defence = 0, glass = 0, vatality = 0, active_id = new List<List<int>>() { new List<int>() { 11, 1 } }, passive_id = new List<List<int>>() {  } } },
            {400003, new CardClass() { id = 400003, name = "转移刺", icon = "400003转移刺", type = 4, cost = 2, leftAttribute = 2, rightAttribute = 3, blade = 0, magic = 3, defence = 1, glass = 0, vatality = 0, active_id = new List<List<int>>() { new List<int>() { 1, 1, 1 }, new List<int>() { 5, 2 } }, passive_id = new List<List<int>>() {  } } },
            {400004, new CardClass() { id = 400004, name = "横劈", icon = "400004横劈", type = 4, cost = 3, leftAttribute = 1, rightAttribute = 3, blade = 10, magic = 0, defence = 2, glass = 0, vatality = 0, active_id = new List<List<int>>() { new List<int>() { 1, 0, 1 } }, passive_id = new List<List<int>>() {  } } },
            {400005, new CardClass() { id = 400005, name = "恢复", icon = "400005恢复", type = 4, cost = 2, leftAttribute = 1, rightAttribute = 4, blade = 5, magic = 0, defence = 0, glass = 1, vatality = 0, active_id = new List<List<int>>() { new List<int>() { 2, 1, 1 } }, passive_id = new List<List<int>>() {  } } },
            {400006, new CardClass() { id = 400006, name = "基本功", icon = "400006基本功", type = 4, cost = 4, leftAttribute = 2, rightAttribute = 5, blade = 0, magic = 10, defence = 0, glass = 0, vatality = 8, active_id = new List<List<int>>() { new List<int>() { 1, 1, 1 }, new List<int>() { 2, 4, 1 }, new List<int>() { 5, 1 } }, passive_id = new List<List<int>>() {  } } },
        };
    }
