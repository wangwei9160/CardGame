...
public class DialogConfig
{
    ...
    static DialogConfig()
    {
        m_Dic = new Dictionary<int, DialogClass>()
        {
            ...
            {8, new DialogClass() { id = 8, content = "老远就寻着茶香,你望见这隐秘的林中居然支着间简陋茶摊。走近细看,布幡上绣着“清心”二字。一个老翁在店旁扇着炉火,陶壶咕嘟作响,飘出略带药草味的茶香。正好你口渴难耐,何不进去稍歇？", op_ids = new List<int>() { 81, 82 } } },
            ...
            {10, new DialogClass() { id = 10, content = "俗话说“人是铁饭是钢”,如果有一间小吃摊可以平息你的饥肠,你会作何选择？容不得你在温饱和钱币之间做抉择,恍然间你已站到了“三十文管饱”的一个小吃摊的幡旗下。", op_ids = new List<int>() { 101102103 } } },
            {11, new DialogClass() { id = 11, content = "道旁,你发现了一个巴掌般大的青铜壶,壶身刻满了饕餮纹。壶口飘出青烟,凝成了一张模糊的人脸：“凡人,搓一把？五十文钱一局,赢了,宝归你,输了…嘿嘿,不过赔点小钱！”", op_ids = new List<int>() { 111112 } } },
            {12, new DialogClass() { id = 12, content = "“参天树下,有奇宝人”。这个你小时候就耳熟能详的俗语里的奇宝人,此刻就站在你的面前,你有点不敢相信地看了看你身旁屹立的参天大树,又看了看你面前的奇宝人。还不等你开口发问,他已说到：“小友,若你有心换些珍品,我可与你做些买卖。”", op_ids = new List<int>() { 121122 } } },
        };
    }
