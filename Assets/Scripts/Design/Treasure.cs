...
public class TreasureConfig
{
    ...
    static TreasureConfig()
    {
        m_Dic = new Dictionary<int, TreasureClass>()
        {
            ...
            {1009, new TreasureClass() { ID = 1009, Name = "口哨", Icon = "1009口哨", Type = 1, Description = "每场战斗中，第一张随从牌的法力值消耗减少", PS = "" } },
            {1010, new TreasureClass() { ID = 1010, Name = "虎皮披风", Icon = "1010虎皮披风", Type = 1, Description = "战场上每有一个友方随从，你手牌中的随从获得+1/+1", PS = "" } },
            {1011, new TreasureClass() { ID = 1011, Name = "望远镜", Icon = "1011望远镜", Type = 1, Description = "你的法术牌在对最后方的敌人释放时获得+2/+2", PS = "" } },
            {1012, new TreasureClass() { ID = 1012, Name = "细长法杖", Icon = "1012细长法杖", Type = 1, Description = "友方战场上每有一个空的随从位，你的手牌中的法术获得+1/+1", PS = "" } },
            ...
            {1017, new TreasureClass() { ID = 1017, Name = "鱼叉", Icon = "1017鱼叉", Type = 1, Description = "每当一名敌人受到攻击后，一名随机的友方随从获得1剑增益", PS = "" } },
            ...
            {1021, new TreasureClass() { ID = 1021, Name = "蚀工", Icon = "1021蚀工", Type = 1, Description = "战斗中奇数回合敌人每次受到的伤害值+1，偶数回合则-1", PS = "" } },
            ...
            {2012, new TreasureClass() { ID = 2012, Name = "狼皮披风", Icon = "2012狼皮披风", Type = 2, Description = "友方战场上每有一个空的随从位，你手牌中的随从获得+1/+1", PS = "" } },
    ...
    public static List<TreasureClass> GetAll()
    {
